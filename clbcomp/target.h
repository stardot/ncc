/*
 * C compiler file clbcomp/target.h
 * Copyright (C) Codemist Ltd., 1988.
 * Copyright (C) Acorn Computers Ltd., 1988
 * Copyright (C) Advanced Risc Machines Ltd., 1991, 1996
...
/*#define TARGET_HAS_DATA_VTABLES         0*/
