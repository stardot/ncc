...
static int32 sprintstruct(char *pp, TypeExpr *type)
{
    ...
    {   char dbxclass = 0;
        switch (sort = (attributes_(b) & ENUMORCLASSBITS)) {
            case bitoftype_(s_struct): dbxclass = 's'; break;
            case bitoftype_(s_class):  dbxclass = 's'; break;
            case bitoftype_(s_union):  dbxclass = 'u'; break;
            case bitoftype_(s_enum):   dbxclass = 'e'; break;
