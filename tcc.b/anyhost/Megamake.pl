...
sub tool_only {
    ...
    &out(&pname("CFLlex=".$dfl."TARGET_IS_ARM%;"));
    &out(&pname("CFLpp=".$dfl."TARGET_IS_ARM%;"));
    &out(&pname("CFLsem=".$dfl."TARGET_IS_ARM%;"));
    &out(&pname("CFLsimplify=".$dfl."TARGET_IS_ARM%;"));
    &out(&pname("CFLsyn=".$dfl."TARGET_IS_ARM%;"));
    &out(&pname("CFLvargen=".$dfl."TARGET_IS_ARM%;"));
    &out("\n");
}

sub tool_host_defs {
    &tool_host_defs_common;
    $targetcflextra = " ".&pname($dfl)."PEEPHOLER";
}
